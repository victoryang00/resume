...
\section{\en{Portfolios}\zh{项目}}
\datedsubsection{\href{https://github.com/chocopy-llvm/chocopy-llvm}{\textbf{ChocoPy Compiler\tiny{https://github.com/chocopy-llvm/chocopy-llvm}}}}{\tiny{\en{A compiler to LLVM IR and to riscv assembly of python 3.6 subset as ShanghaiTech Compiler class project}
\zh{一个从 python3.6 子集编译至 LLVM IR 和 riscv 汇编的编译器，作为编译原理课的 project}
}}

\datedsubsection{\href{https://github.com/LemonHX/ioring-rs}{\textbf{IORing Rust\tiny{https://github.com/LemonHX/ioring-rs}}}}{\tiny{\en{IORing Rust for windows, support \href{https://github.com/bytedance/monoio}{monoio}}\zh{windows上的IORing Rust版，支持\href{https://github.com/bytedance/monoio}{monoio}}}}
...
\datedsubsection{\href{https://github.com/eunomia-bpf/OpenCopilot}{\textbf{OpenCopilot\tiny{https://github.com/eunomia-bpf/OpenCopilot}}}}{\tiny{\en{Open source implementation of Windows Copilot for system maintainance}\zh{用于系统维护的 Windows Copilot 开放源码实施方案}}}
...
\begin{itemize}[parsep=0.25ex]
      ...
      \item \en{\textbf{System}:
                  Specialist in Compiler \& Performance Analysis, familiar with \texttt{LLVM}, \texttt{MLIR}, \texttt{Linux}, \texttt{eBPF}}
            \zh{\textbf{系统}:
                  熟悉各种编译器及操作系统内核的概念与设计，熟悉各种内核性能调优工具，例如\texttt{LLVM}, \texttt{MLIR}, \texttt{Linux}, \texttt{eBPF}。}
