...
\begin{itemize}
      ...
      \zh{设计一种硬件软件协同的CXL.cache数据迁移方法。}}\includegraphics[width=\linewidth/38]{cxlmemuring.png}
      \item \small{ \en{Make Virtual Machine migration based on WebAssembly and WASI}
      \zh{设计一种基于WebAssembly和WASI的虚拟机迁移方法。}}\includegraphics[width=\linewidth/38]{webassembly.png}
