...
\datedsubsection{\href{https://github.com/Sluglab/tva}{\textbf{TVA\tiny{https://github.com/Sluglab/TVA}}}}{\tiny{\en{Exploiting Control-flow Enforcement Technology for Sound and Precise Static Binary Disassembly}\zh{利用控制流执行技术进行精确静态二进制反汇编}}}
...
\datedsubsection{\href{https://github.com/Multi-V-VM/MVVM}{\textbf{MVVM\tiny{https://github.com/Multi-V-VM/MVVM}}}}{\tiny{\en{An LLM agent debugging playground}\zh{一个 LLM agent 调试的 playground}}}

\datedsubsection{\href{https://github.com/victoryang00/ZLUDA}{\textbf{ZLUDA\tiny{https://github.com/victoryang00/ZLUDA}}}}{\tiny{\en{Live Migration middleware for Heterogeneous GPU}\zh{为了 HeteroGPU Live Migration 设计的中间层}}}
