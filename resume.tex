...
\basicInfo{
      \email{vickiegpt@ucsc.edu} \textperiodcentered\
...
\datedsubsection{\href{https://github.com/vickiegpt/ZLUDA}{\textbf{ZLUDA\tiny{https://github.com/Multi-V-VM/hetGPU}}}}{\tiny{\en{Live Migration middleware for Heterogeneous GPU}\zh{为了 HeteroGPU Live Migration 设计的中间层，实现了ptx for intel gpu以及 ptx 的 ckpt restore}}}
